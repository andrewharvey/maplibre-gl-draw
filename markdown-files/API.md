...
Notice that the `point` argument requires `x`, `y` coordinates from pixel space,
...
This event will _not_ fire when a feature is created or deleted. To track those
